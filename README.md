...
파이선으로 구현을 할 내용은<del>웹 크롤링 </del>과 관련 있는 부분을 시작하여 파일관리, <del>간단한 프로그램(복권 추첨 프로그램, 시계 구현)</del>, 데이터 분석, 갤러그 슈팅게임, 웹 서버 채팅프로그램 순으로 업로드 될 
예정입니다.

※ 20200712 웹 크롤링 코드 업로드 완료되었습니다.
※ 20200713 파이썬을 기반으로 작성된 간단한 프로그램 코드 업로드 완료 되었습니다.
